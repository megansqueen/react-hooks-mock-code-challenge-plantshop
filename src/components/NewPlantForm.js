...
function NewPlantForm({ handleItem, setPlants, plants }) {
  ...
  return (
    <div className="new-plant-form">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input onChange={(e) => setPrice(e.target.value)}type="number" name="price" step="0.01" placeholder="Price" price={price}/>
